...
var transferUnregisteredUserImageToRegisteredUser = function (imageID, username) {
    return new Promise(function (resolve, reject) {
        imageEntryCollection.findOneAndUpdate({ id: imageID }, { $set: { username: username }, $unset: { unregisteredSessionID: "" } }, function (err, result) {
            if (err) {
                reject({
                    message: "There was an error transferring guest image to user " + username + "."
                });
                return;
            }
...
var transferUnregisteredUserImageMultiToRegisteredUser = function (imageIDs, username) {
    return new Promise(function (resolve, reject) {
        imageEntryCollection.updateMany({ id: { $in: imageIDs } }, { $set: { username: username }, $unset: { unregisteredSessionID: "" } }, function (err, result) {
            if (err) {
                reject({
                    message: "There was an error transferring guest images to user " + username + "."
                });
                return;
            }
            resolve(result);
...
module.exports.transferUnregisteredUserImageToRegisteredUser = transferUnregisteredUserImageToRegisteredUser;
module.exports.transferUnregisteredUserImageMultiToRegisteredUser = transferUnregisteredUserImageMultiToRegisteredUser;
