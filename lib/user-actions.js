...
module.exports.transferGuestImagesToUser = function (session, imageIDs) {
    return new Promise(function (resolve, reject) {
            ...
            if (err || data.length === 0) {
                ...
                authorizeUserMultiImageOperation(session, data)
                    .then(function (images) {
                        databaseOps.transferUnregisteredUserImagesToRegisteredUser(imageIDs, session.user.username)
