...
describe("integ", () => {
    describe("user comments", () => {
        ...
        it("should fail to return user comments if fail to retrieve comments", async () => {
            ...
            const findCommentsForUserStub = stub(databaseOps, "findCommentsForUser").callsArgWith(
                1,
        ...
        it("should fail to return user comments if fail to retrieve image entry attributes from database", async () => {
            ...
            const findImageAttributesStub = stub(databaseOps, "findImageAttributes").callsArgWith(
                1,
                new Error("Error finding image"),
                null
            );
